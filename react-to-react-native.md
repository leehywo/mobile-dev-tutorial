...
>
> 같은 시리즈의 네이티브 트랙([Android](./android-kotlin-compose.md) · [iOS](./ios-swift-swiftui.md))이 "JS 개발자 → Kotlin/Swift"라면,
...
네이티브 트랙([Android](./android-kotlin-compose.md) · [iOS](./ios-swift-swiftui.md))과 **같은 앱들**을 RN으로. 비교하며 보면 "RN이 얼마나 React 그대로인지" 체감됩니다.
