# 네이티브 앱 개발 튜토리얼 (완전판)
## JavaScript 풀스택 개발자를 위한 Android(Kotlin) & iOS(Swift) 입문

> **학습 전략**: 각 플랫폼별로 동일한 앱을 만들면서 비교 학습합니다.
> 환경 세팅 → 문법 기초 → 샘플 앱 4개를 단계별로 완성합니다.
>
> 같은 시리즈: [React Native 트랙](./react-to-react-native.md) · [Unity(C#) 트랙](./react-to-unity.md) · [트랙 선택 가이드(README)](./README.md)
>
